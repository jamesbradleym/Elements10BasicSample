...
namespace Elements10BasicSample
{
    public class Function
    {
        ...
        private IModelStore<Elements10BasicSampleInputs> store;

        public async Task<Elements10BasicSampleOutputs> Handler(Elements10BasicSampleInputs args, ILambdaContext context)
        {
            ...
            { 
                ...
                {
                    this.store = new S3ModelStore<Elements10BasicSampleInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
                }
                else
                {
                    this.store = new UrlModelStore<Elements10BasicSampleInputs>();
                }
            }

            var l = new InvocationWrapper<Elements10BasicSampleInputs,Elements10BasicSampleOutputs> (store, Elements10BasicSample.Execute);
